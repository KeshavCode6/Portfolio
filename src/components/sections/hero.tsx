    ...
    return (
        ...
        >
            <div className="text-center md:text-left max-w-2xl">
                ...
                <p className="text-sm md:text-md max-w-md mx-auto md:mx-0 mb-6 z-50">
                ...
                <div className="flex flex-col sm:flex-row gap-2 justify-center md:justify-start">
                    ...
                    <Button className="w-full sm:w-auto text-sm" variant="outline" size="lg"
                        onClick={() => handleLinkClick("#freelancing")}                        >
                        Hire Me Today <Pen className="h-4 w-4 ml-2" />
                    </Button>
                </div>
            </div >
