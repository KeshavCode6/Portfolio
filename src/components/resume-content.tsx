        ...
        <>
            ...
            <section className="mt-8">
                ...
                <div className="mt-2 space-y-4">
                    <div>
                        <p className="font-medium">President in School Coding Club</p>
                    ...
                    <div>
                        <p className="font-medium">Reporter in School Cybersecurity Club</p>
                        <ul className="list-disc list-inside">
                            <li>Aided in monthly club meeting planning and execution</li>
                            <li>Manage and Run Instagram</li>
                        </ul>
                    </div>
                    <div>
